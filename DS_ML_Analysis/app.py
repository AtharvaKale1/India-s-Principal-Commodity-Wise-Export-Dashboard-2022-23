...
with st.sidebar:
    ...
    with st.expander("ℹ️ About this Dashboard"):
        st.info(
            """
            This dashboard provides an analysis of India's principal commodity exports for 2022-23.
...
st.markdown("Navigate through different analysis modes to uncover insights from India's 2022-23 export data.")
